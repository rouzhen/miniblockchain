// defines the message types for the CRUD operations on posts
// These message types include the necessary information to perform each operation, such as the post content for a create operation or the post ID for a delete operation.
package types
