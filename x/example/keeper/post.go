//This file contains the CRUD operations for the "post" type.
// deals with operations related to a "post" type, such as adding a new post, fetching posts, updating, or deleting them.
